...
public :
	...
	// Manipulating the shape transform during the simulation may cause non-physical behaviour.
...
inline b3Body* b3Shape::GetBody() { return m_body; }

inline const b3Body* b3Shape::GetBody() const { return m_body; }

inline const b3Transform& b3Shape::GetTransform() const { return m_local; }
...
inline bool b3Shape::IsSensor() const { return m_isSensor; }

inline r32 b3Shape::GetDensity() const { return m_density; }

inline void b3Shape::SetDensity(r32 density) { m_density = density; }

inline r32 b3Shape::GetRestitution() const { return m_restitution; }

inline void b3Shape::SetRestitution(r32 restitution) { m_restitution = restitution; }

inline void* b3Shape::GetUserData() const { return m_userData; }

inline void b3Shape::SetUserData(void* data) { m_userData = data; }
